...
DROP POLICY IF EXISTS "Only admins and editors can create posts" ON public.posts;
DROP POLICY IF EXISTS "Only admins and editors can update posts" ON public.posts;
DROP POLICY IF EXISTS "Only admins and editors can delete posts" ON public.posts;
